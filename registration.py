...
<body>
    ...
    <div class="form">
        ...
        <br>
        <form action="backend/regcode.py" method="post">
            ...
            <table>
               ...
               <tr>
                    <td>Email</td><td><input type="email" name="email" placeholder="Enter Your Password"></td>
                </tr>
              <tr>
                    <td>Password</td><td><input type="password" name="password" placeholder="Create Password"></td>
                </tr>
